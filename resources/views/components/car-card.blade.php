<div class="overflow-hidden rounded-2xl" data-aos="flip-right">
    <div class="h-80 overflow-hidden bg-gray-800">
        <img class="h-full mx-auto object-cover" src="{{ $car->getFirstMediaUrl('photo') }}" alt="">
    </div>
    <div class="relative z-10 -mt-5 rounded-2xl bg-gray-800 p-3 py-5 text-white">
        ...
        <div class="mt-4 grid grid-cols-3 gap-5">
            ...
            <div class="flex flex-col justify-center text-center">
                <div class="flex justify-center">
                    <div class="size-10 rounded-full border-2 p-2 text-center">
                ...
                <span class="block text-center">{{ $car->seats }} seaters</span>
            </div>
            ...
            <div class="flex flex-col justify-center text-center">
                ...
                <span class="block text-center">{{ $car->type }}</span>
            </div>
            ...
            <div class="flex flex-col justify-center text-center">
                ...
                <span class="block text-center">{{ $car->fuel }}</span>
            </div>
        ...
        <div class="mx-auto mt-5 flex w-fit items-center overflow-hidden rounded-full">
            <a class="group flex items-center gap-3 bg-white p-3 font-bold text-black"
                ...
                <span
                    class="w-0 overflow-hidden whitespace-nowrap transition-all duration-300 ease-in-out group-hover:w-[100px]">
                    Call to book
                </span>

            </a>

            <a class="group flex items-center gap-3 bg-green-700 p-3 font-bold text-white"
                href="//wa.me/{{ env('WHATSAPP_NUMBER') }}?text=i want to book {{ $car->name }}">

                <span
                    class="w-0 overflow-hidden whitespace-nowrap transition-all duration-300 ease-in-out group-hover:w-[90px]">
                    whatsapp</span>
                <svg class="size-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path
