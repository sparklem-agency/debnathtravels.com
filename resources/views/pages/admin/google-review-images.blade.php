...
name('admin.google-review-images');
...
new class extends Component {
    ...
    function save()
    {
        ...
        foreach ($this->photos as $photo) {
            $user->addMedia($photo)->toCollection('google-reviews');
        }
...
<x-admin-layout title="google reviews">
    @volt('google-reviews')
        <div>
            <x-mary-header title="google-reviews" separator />
            ...
            @php
                $photos = $user->getMedia('google-reviews');
